function [lon_lat_f] = make_dense_points_downdip_boundary(A)

% This function generates multiple points in between two existing points, by considering simple linear relationship (y=mx+c)
% Spacing (n=0.5) is kept coarse to get a smooth boundary of the polygon (i.e., Himalayan downdip boundary)
...
lon_lat_f=[];
n=0.5;   % Spacing of points. Small spacing = Dense points
